...
# TestNode: A peer we use to send messages to bulld, and store responses.
...
class CompactBlocksTest(BullTestFramework):
    ...
    # This test actually causes bulld to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bulld requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bulld to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bulld will not send blocktxn responses for blocks whose height is
