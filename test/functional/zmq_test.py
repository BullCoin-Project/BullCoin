...
class ZMQTest (BullTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bull has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bulld has not been built with zmq enabled.")
