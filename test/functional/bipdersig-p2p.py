...
class BIP66Test(BullTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bulld is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bulld produces more specific reject
            # reasons.
