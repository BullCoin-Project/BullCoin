...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BullTestFramework
    pass

class ExampleTest(BullTestFramework):
    # Each functional test is a subclass of the BullTestFramework class.
    ...
    def custom_method(self):
        ...
        BullTestFramework class so other tests can use it."""
