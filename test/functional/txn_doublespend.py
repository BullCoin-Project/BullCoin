...
class TxnMallTest(BullTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 BUL:
        ...
        # First: use raw transaction API to send 1240 BUL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BUL coin each
        ...
        # Node0's balance should be starting balance, plus 50BUL for another
        ...
        # Node0's total balance should be starting balance, plus 100BUL for 
