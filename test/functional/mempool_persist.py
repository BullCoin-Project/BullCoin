...
By default, bulld will dump mempool on shutdown and
...
class MempoolPersistTest(BullTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give bulld a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent bulld from writing mempool.dat to disk. Verify that `savemempool` fails")
