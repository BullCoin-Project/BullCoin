...
This document provides guidelines for internationalization of the Bull Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bull_en.ts` remains unchanged.
