...
#ifndef BULL_TEST_SCRIPTNUM10_H
#define BULL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bull Core 0.10.0, for cross-comparison.
 */
public:
