...
#if defined(NDEBUG)
# error "Bull cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bull Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BUL additional fees, %d delta bytes\n",
